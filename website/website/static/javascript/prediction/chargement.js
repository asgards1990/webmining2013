...
function loadChargement(nomDuCadre){
	...
	boxLoader.style.cssText='position:relative;width:100%;height:780px;z-index:10;background-color:rgba(150,150,150,0.8);'
	document.getElementById(nomDuCadre).appendChild(boxLoader);
	var loader=document.createElement("div");
	loader.id="loaderProvisoire";
	loader.style.cssText='position:relative;width:300px;height:780px;margin:0 auto;z-index:10;'
