...
function verifSiRequete(){
	...
	document.getElementById("prediction_item_actors").getElementsByTagName("div")[0].style.backgroundImage="url('../static/img/prediction/red2.png')";
	//document.getElementById("prediction_item_actors").getElementsByTagName("div")[0].style.backgroundColor="rgba(0,0,0,0)"
		...
		document.getElementById("prediction_item_actors").getElementsByTagName("div")[0].style.backgroundImage="url('../static/img/prediction/orange2.png')";
		}
		else{
		document.getElementById("prediction_item_actors").getElementsByTagName("div")[0].style.backgroundImage="url('../static/img/prediction/green2.png')";
		}
	}
	if (nbdirector<nbdirector_min){
		document.getElementsByClassName("itemDirector")[0].getElementsByTagName("div")[0].style.backgroundImage="url('../static/img/prediction/red2.png')";
	}
	else{
		document.getElementsByClassName("itemDirector")[0].getElementsByTagName("div")[0].style.backgroundImage="url('../static/img/prediction/green2.png')";
	}
	if(nbgenres<nbgenres_min){
		document.getElementById("prediction_item_genres").getElementsByTagName("div")[0].style.backgroundImage="url('../static/img/prediction/red2.png')";
	}
	else{
		if(nbgenres<nbgenres_max){
		document.getElementById("prediction_item_genres").getElementsByTagName("div")[0].style.backgroundImage="url('../static/img/prediction/orange2.png')";
		}
		else{
		document.getElementById("prediction_item_genres").getElementsByTagName("div")[0].style.backgroundImage="url('../static/img/prediction/green2.png')";
		}
	}
	if(nbkeywords<nbkeywords_ok){
	document.getElementById("prediction_item_keyword").getElementsByTagName("div")[0].style.backgroundImage="url('../static/img/prediction/orange2.png')";
	}
	else{
	document.getElementById("prediction_item_keyword").getElementsByTagName("div")[0].style.backgroundImage="url('../static/img/prediction/green2.png')";
	}
...
$(document).ready(function(){
	...
	document.getElementsByClassName("item6")[0].getElementsByTagName("div")[0].style.backgroundImage="url('../static/img/prediction/orange2.png')";
})
